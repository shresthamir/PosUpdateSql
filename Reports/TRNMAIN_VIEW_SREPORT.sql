...
AS
SELECT A.VCHRNO, A.DIVISION,A.CHALANNO,A.TRNDATE,A.BSDATE,A.TRNTIME,TRNMODE,TRNAC, B.ACNAME, REMARKS,TERMINAL,RECEIVEBY,MEMBERNO,ISNULL(B.VATNO,'') VATNO,ISNULL(RATETYPE,0) RATETYPE, 
