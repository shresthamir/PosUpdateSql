...
@CHK_IncludeAcBaseCnDn  TINYINT = 0   --IncludeAcBaseCnDn:1:0
...
(
	...
	WHERE @CHK_IncludeAcBaseCnDn = 1 AND M.PhiscalID = @FYID AND M.DIVISION LIKE @DIVISION AND M.TRNDATE BETWEEN @DATE1 AND @DATE2 AND M.VOUCHERTYPE IN ('CN' , 'DN') 
	AND ISNULL(ISNULL(A.ACNAME, M.BILLTO),'') <> ''
