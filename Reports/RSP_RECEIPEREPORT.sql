...
JOIN vwActiveRecipeMain RM ON RM.MCODE = M.MCODE
JOIN vwActiveRecipeProd RP ON RP.ENO = RM.ENO
...
JOIN vwActiveRecipeProd RP ON RP.RMCODE = M.MCODE
JOIN vwActiveRecipeMain RM ON RM.ENO = RP.ENO
