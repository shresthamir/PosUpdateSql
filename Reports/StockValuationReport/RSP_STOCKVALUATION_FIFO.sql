...
IF EXISTS (SELECT * FROM ReportSetting WHERE ReportName = 'Stock Valuation Report' AND SettingName = 'ValuationMethod' AND SettingValue = '1')
BEGIN
	EXEC RSP_STOCKVALUATION_FIFO_DIVISIONWISE 
	@DATE = @DATE,
	@PATH = @PATH,
	@FYID = @FYID,
	@DETAIL = @DETAIL,
