...
@DATE2 DATE
AS
--SET @DIVISION = 'PKR'; SET @Warehouse = 'Main Warehouse'; SET @PhiscalId = '78/79'; SET @DATE1 = '1 SEP 2021'; SET @DATE2 = '19 JAN 2022'
SET NOCOUNT ON
...
(
	...
	SUM(S.Quantity * B.QTY / A.FACTOR) CONSUMPTION, D.WHOUSE
	FROM vwPendingConsumptionList PC 
	INNER JOIN SALES_TRNPROD S ON S.VCHRNO = PC.VCHRNO 
	INNER JOIN TRNPROD_RECEIPE B ON S.MCODE = B.PMCODE AND S.VCHRNO = B.VCHRNO AND S.SNO = B.SNO
