...
--select @DATE1='2024-10-17 00:00:00',@DATE2='2024-11-15 00:00:00',@REPORT_TYPE=1,@SHOWDETAL_REPORT=1,@div='%',@INCLUDE_RETURN=0,@VOUCHER_TYPE = 'PI'
...
BEGIN	
	IF @REPORT_TYPE = 1		--VOUCHER WISE
		BEGIN
			...
			REMARKS,ISNULL(REFBILL,CHALANNO)REFBILL,ISNULL(VNUM,VCHRNO)VNUM,TRNTIME,TRNUSER,PHISCALID ,BILLTOTEL
			...
			IF @SHOWDETAL_REPORT = 0		-- SUMMARY REPORT					
				...
				, REMARKS, PARTY,SUPPLIER_PAN, DIVNAME, TRNUSER, VNUM, DIVISION, FLG FROM 
				(
					SELECT A.TRNDATE,A.BSDATE,A.VCHRNO,A.REFNO,A.TRNMODE, A.TOTAMNT,A.DCAMNT,0 STAX,A.NETSALE,A.NONTAXABLE,A.TAXABLE,A.VATAMNT, A.TOTAL, A.REMARKS,A.PARTY,SUPPLIER_PAN, A.DIVNAME,A.TRNUSER,A.VNUM,A.DIVISION,'A' FLG FROM #TRNMAIN A
					UNION ALL
					SELECT NULL TRNDATE,NULL BSDATE,NULL VCHRNO,NULL REFNO,'TOTAL >>' TRNMODE,SUM(A.TOTAMNT),SUM(A.DCAMNT),0,SUM(A.NETSALE),SUM(A.NONTAXABLE),SUM(A.TAXABLE),SUM(A.VATAMNT),SUM(A.TOTAL),NULL REMARKS,NULL PARTY,NULL SUPPLIER_PAN,NULL DIVISION,NULL TRNUSER,'ZZ9999999' VNO,NULL DIVID,'B' FLG FROM #TRNMAIN A
			...
			ELSE			-- DETAIL REPORT
				BEGIN
					...
					SELECT * FROM 
					(
					SELECT A.TRNDATE,A.BSDATE,A.VCHRNO,A.REFNO,A.PARTY,A.SUPPLIER_PAN,A.TRNMODE,X.QTY, NULL RATE,A.TOTAMNT,A.DCAMNT,0 STAX,A.NONTAXABLE,A.TAXABLE,A.VATAMNT,A.TOTAL,A.REMARKS,A.TRNTIME, A.TRNUSER,A.DIVNAME,A.VNUM,A.DIVISION,'A' FLG,A.TRNDATE TDATE FROM #TRNMAIN A
					...
					UNION ALL
					SELECT A.TRNDATE,A.BSDATE,A.VCHRNO,A.MENUCODE,A.PRODUCT,NULL SUPPLIER_PAN,A.UNIT,A.QUANTITY,A.RATE,A.AMOUNT,A.DISCOUNT,0 SERVICETAX,A.NONTAXABLE,A.TAXABLE,A.VAT,A.NETAMNT,NULL PAXNO,NULL TRNTIME,NULL TRNUSER,NULL DIVISION,A.VNUM, NULL DIVID,'B' FLG,A.TDATE FROM #RMD_TRNPROD A
					UNION ALL
					SELECT NULL TRNDATE,NULL BSDATE,NULL VCHRNO,NULL CHALANNO,NULL PARTY,NULL SUPPLIER_PAN,NULL TRNMODE,NULL QTY, NULL RATE,NULL TOTAMNT,NULL DCAMNT,NULL STAX,NULL NONTAXABLE,NULL TAXABLE,NULL VATAMNT,NULL TOTAL,NULL PAXNO,NULL TRNTIME, NULL TRNUSER,NULL DIVISION,A.VNUM,A.DIVISION DIVID,'C' FLG,A.TRNDATE TDATE FROM #TRNMAIN A
					UNION ALL
