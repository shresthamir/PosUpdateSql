...
--DECLARE
	...
	@FYID VARCHAR(10)
AS
--select @DATE1='2023-07-17',@DATE2='2024-02-16',@FYID='80/81',@REPORT_TYPE=3,@SHOWDETAL_REPORT=0,@div='%',@INCLUDE_RETURN=0,@VOUCHER_TYPE = 'PI'
--SET @DATE1 = '01-01-2017'; SET @DATE2 = '01-01-2019'; SET @DIV  ='%'; SET @VOUCHER_TYPE = 'PI'; SET @INCLUDE_RETURN = 0 ; SET @REPORT_TYPE = 1 ; SET @SHOWDETAL_REPORT = 0 ; SET @VCHR = 'X' ; 
