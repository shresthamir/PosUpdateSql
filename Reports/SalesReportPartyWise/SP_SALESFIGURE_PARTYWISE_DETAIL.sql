...
IF @PTYPE= 0 	-- CUSTOMER WISE
	...
	left join #PARTYFILTER ca on ca.ACID=b.TRNAC
	WHERE B.DIVISION LIKE @DIV AND B.TRNDATE BETWEEN @DATE1 AND @DATE2 AND LEFT(A.VCHRNO,2) IN ('SI','SR','TI','CN','RE') AND (B.TRNAC LIKE @ACID OR B.RECEIVEBY LIKE @ACID)
