...
--select  @DATE1='2025-01-01 00:00:00',@DATE2='2025-02-13 00:00:00' ,@VOUCHER_TYPE=N'SI',@INCLUDE_RETURN=1,@REPORT_TYPE=N'1',@SHOWDETAL_REPORT=N'0',@VCHR=N'A',@party=N'%',@sman=N'%',@inad=N'0',@DISCOUNTEDSALES=N'0',@DISRATE=N'0',@COUNTERSALES=N'0',@SALESMANWISESUMMARY=0,@FYID=N'81/82'
...
BEGIN	
	IF @REPORT_TYPE = 1		--VOUCHER WISE
		BEGIN
			...
			A.REMARKS,ISNULL(A.REFBILL,'')REFBILL,ISNULL(A.CUSTOMER_COUNT,0)PAXNO,ISNULL(A.VNUM,A.VCHRNO)VNUM,A.TRNTIME,A.TRNUSER, (A.DCAMNT * 100)/A.TOTAMNT DISRATE,A.CHOLDER,A.PHISCALID, A.VoucherType, BRD.RoomNo,ORDERMODE
			...
			A.TRNTIME,A.TRNUSER,X.NAME DIVNAME,VNUM, A.DIVISION,A.PHISCALID, DP.NAME DeliveryAgent, SI.RecipientName, SI.RecipientMobile, SI.RecipientAddress,A.REMARKS, A.RoomNo, A.ORDERMODE
			...
			IF @SHOWDETAL_REPORT = 0		-- SUMMARY REPORT					
				...
				(
					...
					RecipientMobile, RecipientAddress,A.REMARKS, A.RoomNo, A.ORDERMODE FROM #TRNMAIN A
					UNION ALL
					...
					NULL DIVISION,'ZZ9999999' VNO,NULL DIVID,'B' FLG, NULL, NULL, NULL, NULL ,NULL, NULL, NULL FROM #TRNMAIN A
			...
			ELSE			-- DETAIL REPORT
				BEGIN
					...
					SELECT * FROM 
					(
						SELECT A.TRNDATE,A.BSDATE,A.VCHRNO,A.CHALANNO,A.PARTY,A.TRNMODE,X.QTY, NULL RATE,A.TOTAMNT,A.DCAMNT,A.STAX,A.NONTAXABLE,A.TAXABLE,A.VATAMNT,A.TOTAL,A.PAXNO,A.TRNTIME, A.TRNUSER,A.DIVNAME,A.VNUM,A.DIVISION,'A' FLG, A.RoomNo, A.ORDERMODE FROM #TRNMAIN A
						...
						UNION ALL
						SELECT A.TRNDATE,A.BSDATE,A.VCHRNO,A.MENUCODE,A.PRODUCT,A.UNIT,A.QUANTITY,A.RATE,A.AMOUNT,A.DISCOUNT,A.SERVICETAX,A.NONTAXABLE,A.TAXABLE,A.VAT,A.NETAMNT,NULL PAXNO,NULL TRNTIME,NULL TRNUSER,NULL DIVISION,A.VNUM, NULL DIVID,'B' FLG,NULL , NULL
						FROM #RMD_TRNPROD A
						...
						A.VNUM,A.DIVISION DIVID,'C' FLG, NULL, NULL FROM #TRNMAIN A
						...
						NULL DIVISION,'ZZ99999999'  VNUM,NULL DIVID,'D' FLG, NULL, NULL FROM 
						(
