...
(
	...
	UNION ALL
	SELECT ACID, 'TOTAL : ', NULL, NULL, SUM(BILL_AMNT) , SUM(PAID), SUM(BALANCE), NULL, NULL, NULL, 2, 'G' FROM #RESULT GROUP BY ACID AND @CHK_OnlyDataRow = 0
	UNION ALL 
	SELECT DISTINCT ACID, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,NULL, 3, 'A' FROM #RESULT AND @CHK_OnlyDataRow = 0
) A 
