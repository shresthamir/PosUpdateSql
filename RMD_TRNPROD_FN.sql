...
RETURN
(
	SELECT VCHRNO, CHALANNO, DIVISION, MCODE, HS_CODE, UNIT, Quantity, RealQty, AltQty, RATE, AMOUNT, DISCOUNT, VAT, 
	...
	UNION ALL
	SELECT VCHRNO, CHALANNO, DIVISION, MCODE, HS_CODE, UNIT, Quantity, 
	...
	UNION ALL 
	SELECT A.VCHRNO, A.CHALANNO, A.DIVISION, A.MCODE, A.HS_CODE, A.UNIT, A.Quantity - ISNULL(TP_PI.QUANTITY, 0 ) + ISNULL(TP_DN.QUANTITY,0) Quantity, 0 RealQty, 0 AltQty, A.RATE, 0 AMOUNT, 0 DISCOUNT,0 VAT,	A.REALRATE, 0 EXPORT, 
		...
		(
			SELECT TP.VCHRNO, TP.CHALANNO, TP.DIVISION, TP.MCODE, TP.HS_CODE, TP.UNIT, SUM(TP.REALQTY_IN - TP.REALQTY) Quantity, TP.RATE,
			...
			GROUP BY TP.VCHRNO, TP.CHALANNO, TP.DIVISION, TP.MCODE, TP.HS_CODE, TP.UNIT, TP.RATE, TP.REALRATE,  TP.WAREHOUSE, TP.EXPDATE, TP.ALTUNIT, TP.PRATE, TP.ALTRATE, TP.BC, TP.BATCH, TP.PHISCALID, TP.VoucherType, TP.ISVAT, 
			TP.ITEMDESC
		) AS A
		LEFT JOIN
		(
