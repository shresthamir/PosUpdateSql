...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TRNPROD_COGS' AND COLUMN_NAME = 'ROW_VERSION')
ALTER TABLE TRNPROD_COGS ADD ROW_VERSION rowversion

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'ABBPROD_COGS' AND COLUMN_NAME = 'ROW_VERSION')
ALTER TABLE ABBPROD_COGS ADD ROW_VERSION rowversion

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TRNPROD_COGS' AND COLUMN_NAME = 'ORIGIN_ROW_VERSION')
ALTER TABLE TRNPROD_COGS ADD ORIGIN_ROW_VERSION VARBINARY(25) NULL

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'ABBPROD_COGS' AND COLUMN_NAME = 'ORIGIN_ROW_VERSION')
