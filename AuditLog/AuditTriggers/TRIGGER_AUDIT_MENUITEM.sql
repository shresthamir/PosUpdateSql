CREATE OR ALTER  TRIGGER [dbo].[TRIGGER_AUDIT_MENUITEM] ON [dbo].[MENUITEM]
FOR Insert,update,delete
	...
	EXEC spSaveAuditLog @TableName = N'MENUITEM' , @InsertedJson = @InsertedJson , @DeletedJson = @DeletedJson;