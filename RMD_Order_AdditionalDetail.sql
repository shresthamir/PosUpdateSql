...
CREATE TABLE [dbo].[RMD_Order_AdditionalDetail](
	...
	CONSTRAINT  FK_RMD_Order_AdditionalDetail_OrderMain FOREIGN KEY (VCHRNO, DIVISION, PhiscalID) REFERENCES RMD_ORDERMAIN (VCHRNO, DIVISION, PhiscalID) ON DELETE CASCADE,
