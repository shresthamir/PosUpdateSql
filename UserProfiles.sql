...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'UserProfiles' AND COLUMN_NAME = 'allowTableSplit')
ALTER TABLE UserProfiles ADD allowTableSplit TINYINT NOT NULL DEFAULT (1) WITH VALUES

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'UserProfiles' AND COLUMN_NAME = 'allowTableMerge')
ALTER TABLE UserProfiles ADD allowTableMerge TINYINT NOT NULL DEFAULT (1) WITH VALUES