...
AS      
--SELECT @mCODE=N'M54',@barCode=N'8906087773115',@division=N'PSI',@warehouse=N'Kalanki Warehouse',@PhiscalID=N'80/81',@RATEGROUPID=0,@RATEGROUPID_WSALE=0
...
WHERE P.MCODE = @MCODE AND P.DIVISION = @division and P.WAREHOUSE = @warehouse AND P.PHISCALID = @PHISCALID AND B.BATCHCODE LIKE @BatchCode AND (MI.HASVARIANT = 1 OR ISNULL(P.BC,'') LIKE @BARCODE)      
