...
COALESCE(C.RG_RATE, A.RATE) * A.CONFACTOR * CONVERT(NUMERIC(9,2), (1 - COALESCE(A.SRATE_DISCOUNT, 0)/100)) RATE, 
COALESCE(D.RG_RATE, A.RATE_B) * A.CONFACTOR * CONVERT(NUMERIC(9,2),(1 - COALESCE(A.WSRATE_DISCOUNT,0)/100)) RATE_B,
