CREATE   PROC OSP_GetSalesOrderDetail
--DECLARE
@VCHRNO VARCHAR(25)
AS
...
GROUP BY OM.VCHRNO, OM.TRNAC, OP.MCODE, OP.BC,OP.INDDISCOUNTRATE, MI.DESCA, MI.MENUCODE, OP.RATE, U.CONFACTOR, OP.ALTRATE, OP.ALTUNIT, OP.REALRATE, OP.UNIT, COALESCE(NULLIF(OP.ALTQTY,0), OP.ALTQTY_IN),OP.INDDISCOUNT, OP.AMOUNT,OM.REMARKS,OM.TOTALFLATDISCO
UNT,OP.FLATDISCOUNT,OP.INDDISCOUNT
