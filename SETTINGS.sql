IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'PaymentModes' AND COLUMN_NAME = 'PrintReceipt')
ALTER TABLE PaymentModes ADD PrintReceipt TINYINT

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SETTING' AND COLUMN_NAME = 'RateGroupByDiscount')
ALTER TABLE SETTING ADD RateGroupByDiscount BIT NOT NULL, CONSTRAINT DF_SETTING_RateGroupByDiscount DEFAULT(1) FOR RateGroupByDiscount WITH VALUES

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SETTING' AND COLUMN_NAME = 'ExclusiveVatRate')
ALTER TABLE SETTING ADD ExclusiveVatRate TINYINT NOT NULL, CONSTRAINT DF_SETTING_ExclusiveVatRate DEFAULT (0) FOR ExclusiveVatRate WITH VALUES
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'setting' and column_name = 'RateGroupByDiscount')
ALTER TABLE SETTING ADD RateGroupByDiscount TINYINT
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'setting' and column_name = 'SampleOverallDataForValuation')
ALTER TABLE SETTING ADD SampleOverallDataForValuation TINYINT
...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AdjustmentBatch' AND COLUMN_NAME = 'BatchType')
ALTER TABLE AdjustmentBatch ADD BatchType TINYINT
...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'LOGMAIN_ORDER' AND COLUMN_NAME = 'EID' AND IS_NULLABLE ='YES')
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME= 'SETTING' AND COLUMN_NAME = 'EnableBarcodeDetails' AND DATA_TYPE <> 'tinyint')
BEGIN
	IF OBJECT_ID('DF__SETTING__EnableB__4CE05A84') IS NOT NULL 
	ALTER TABLE SETTING DROP CONSTRAINT DF__SETTING__EnableB__4CE05A84
	UPDATE SETTING SET EnableBarcodeDetails = 0
	ALTER TABLE SETTING ALTER COLUMN EnableBarcodeDetails TINYINT NOT NULL
END
...
ALTER TABLE _LOG_BARCODE ALTER COLUMN SN NUMERIC(18,0) NOT NULL

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'MEMGRADETRAN' AND COLUMN_NAME = 'PointBeforeInvoice')
ALTER TABLE MEMGRADETRAN ADD PointBeforeInvoice DECIMAL(12,2) NOT NULL DEFAULT (0) WITH VALUES


IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SETTING' AND COLUMN_NAME = 'ServiceChargeRate')
ALTER TABLE SETTING ADD ServiceChargeRate DECIMAL(5,3) NOT NULL, CONSTRAINT DF_SETTING_ServiceChargeRate DEFAULT (0) FOR ServiceChargeRate WITH VALUES
