...
SELECT distinct MI.MENUCODE,trp.SNO,bd.SIZE,bd.COLOR,ISNULL(TRP.ITEMDESC, MI.DESCA) ITEMDESC, trp.Quantity, trp.AltQty,ISNULL(A.ALTQTY_IN,0) SalesReturnQty,MI.MCODE,TRP.UNIT,TRP.RATE, TRP.ALTUNIT, TRP.ALTRATE, TRP.REALRATE, TRP.AMOUNT,TRP.DISCOUNT,MI.VAT,
